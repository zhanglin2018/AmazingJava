...
void testClass()
{
  ...
  shared_ptr<Person> shared_Person(new Person("lixiao", "woman"));
...
void testSharedPtr()
{
  ...
  shared_ptr<Person> person1(new Person("zhanglin", "man"));
  ...
  shared_ptr<Person> person4 = std::make_shared<Person>("jiafu", "man");
  cout << person4->getName() << " " << person4->getSex() << " "
      << person4.use_count() << endl;

  shared_ptr<Person> person5(person4);
